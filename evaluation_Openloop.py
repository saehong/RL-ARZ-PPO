...
if control_settings['Scenario'] == 1:
    print('Plotting Outlet Openloop (Setpoint control) Case.')
    ## create meshgrid
    L = settings['L']  #[m]
    dx = settings['dx']
    x = np.arange(0,L+dx,dx)
...
print('-------------------------------------')
if control_settings['Scenario'] == 1:
    sio.savemat('save_mat/ARZ_Openloop_Outlet_Results.mat',{'r_vec_base':r_save_base, 'v_vec_base':v_save_base, 'rwd_base' : reward_save_base, 'input_base': action_save_base, 'xx': xx, 'tt' : tt})
    print('Saved')
elif control_settings['Scenario'] == 2:
    sio.savemat('save_mat/ARZ_Openloop_Inlet_Results.mat',{'r_vec_base':r_save_base, 'v_vec_base':v_save_base, 'rwd_base' : reward_save_base, 'input_base': action_save_base, 'xx': xx, 'tt' : tt})
    print('Saved')
elif control_settings['Scenario'] == 3:
    sio.savemat('save_mat/ARZ_Openloop_Outlet_N_Inlet_Results.mat',{'r_vec_base':r_save_base, 'v_vec_base':v_save_base, 'rwd_base' : reward_save_base, 'input_base': action_save_base, 'xx': xx, 'tt' : tt})
    print('Saved')
